...
export default function HomePage() {
  ...
  useEffect(() => {
    ...
    const bootstrap = async () => {
      ...
      // Validate cookie-backed session before redirecting to dashboard.
      try {
  ...
  return (
    <>
      <CustomCursor />
      <div className="min-h-screen w-full relative overflow-x-hidden bg-white">
        {/* Navigation */}
        <motion.nav 
          className="border-b border-gray-200 backdrop-blur-lg bg-white/95 sticky top-0 z-50 w-full"
          initial={{ y: -100 }}
          animate={{ y: 0 }}
        ...
        <div className="px-6 py-12 md:py-16 w-full max-w-7xl mx-auto">
          ...
          >
            ...
            <motion.h1 
              className="text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold text-black mb-4"
          ...
          >
            {[
              ...
              >
                <GlassCard className="p-8 bg-white border border-gray-200" depth="medium">
                  <motion.div 
          ...
          {/* CTA Section */}
          <motion.div 
            className="bg-black rounded-3xl shadow-2xl p-12 text-center text-white relative overflow-hidden border border-black"
          ...
          >
            ...
            <div className="flex flex-wrap gap-4 justify-center">
              <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                <Link
                  href="/register"
                  className="inline-block px-10 py-4 bg-white text-black font-bold rounded-lg shadow-lg hover:shadow-xl transform transition-all"
                >
                  Sign Up Free
                </Link>
              </motion.div>
              <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                <Link
                  href="/login"
                  className="inline-block px-10 py-4 bg-transparent border-2 border-white text-white font-bold rounded-lg hover:bg-white/10 transition-all"
                >
                  Login
                </Link>
              </motion.div>
            ...
            {/* Demo Account Info */}
            <motion.div 
              className="mt-10 p-6 bg-gray-900 rounded-2xl border border-gray-700"
