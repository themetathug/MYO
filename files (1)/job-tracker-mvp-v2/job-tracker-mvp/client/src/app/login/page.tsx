...
export default function LoginPage() {
  ...
  useEffect(() => {
    ...
    // If already logged in and refresh cookie is valid, skip login page.
  ...
  const handleDemoLogin = () => {
    toast('Create your free account — it takes 30 seconds!', { icon: '👋' });
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center justify-end">
              <button
                type="button"
                onClick={() => toast('Password reset is coming soon. Please contact support if you need access.', { icon: 'ℹ️' })}
